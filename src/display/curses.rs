...
const COLOR_TABLE: [i16; 8] = [
	COLOR_WHITE, // the default foreground color must be the first (see #77)
	COLOR_BLUE,
	COLOR_CYAN,
	COLOR_GREEN,
	COLOR_MAGENTA,
...
impl Curses {
	pub fn new() -> Self {
		...
		Self {
			...
			number_of_color_pairs: pancurses::COLOR_PAIRS() as usize,
	...
	pub fn init_color_pair(&mut self, foreground: Color, background: Color) -> i16 {
		...
		pancurses::COLOR_PAIR(index as u64) as i16
	}
